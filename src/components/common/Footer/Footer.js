    ...
    return (
        <>
            <footer id="contact-us">
                ...
                <div className="d-flex row flex-row-reverse align-items-center justify-content-center">

                    <div className="col-12 text-center d-block d-md-none mb-5">
                    ...
                    <a href="https://faramarzii.ir" className="col-4 text-center d-none d-md-block">
                        <img src={Faramarzi} alt="Faramarzi" />
                    </a>


                    <div className="col-6 col-md-2 Social" onClick={githubShow} >
                    ...
                    <div className="col-6 col-md-2 Social" onClick={whatsappShow}>
            ...
            <div className={instagram === true ? "modalll show" : "modalll"}>
                ...
                <div className="content-modal zoom">
                    ...
                    <div className="modal-body">
                        <a href="https://www.instagram.com/mohammadmahdi.mmf/" target="_blank" className="Personal-link">
                            <div className="img">
                                <img src={mmf} alt='' />
                            </div>
                            <div className="text">
                        ...
                        <a href="https://www.instagram.com/alirez.af/" target="_blank" className="Personal-link">
                            <div className="img">
                                <img src={af} alt='' />
                            </div>
                            <div className="text">
            ...
            <div className={github === true ? "modalll show" : "modalll"}>
                ...
                <div className="content-modal zoom">
                    ...
                    <div className="modal-body">
                        <a href="https://github.com/MohammadMahdiFaramarzi" target="_blank" className="Personal-link">
                            <div className="img">
                                <img src={mmf} alt='' />
                            </div>
                            <div className="text">
                        ...
                        <a href="https://github.com/Alirezafaramarzii" target="_blank" className="Personal-link">
                            <div className="img">
                                <img src={af} alt='' />
                            </div>
                            <div className="text">
